...
> [!NOTE]
>
> У нас есть целая выделенная организация [@proj-airi](https://github.com/proj-airi) для всех подпроектов, родившихся из Проекта NIMARA. Проверьте её!
>
...
>
> **Если вы заинтересованы, почему бы не представить себя здесь? [Хотите присоединиться к нам в создании NIMARA？](https://github.com/moeru-ai/airi/discussions/33)**
...
- [NIMARA Factorio](https://github.com/moeru-ai/airi-factorio): Позволяет NIMARA играть в Factorio
