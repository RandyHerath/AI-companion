---
title: 'DreamLog 0x1'
description: 'Backstory of Project NIMARA!'
category: DreamLog
date: 2025-06-16
excerpt: 'The backstory of Project NIMARA! Why this project?'
preview-cover:
...
import projectNIMARABannerLight from './assets/banner-light-1280x640.avif';
import projectNIMARABannerDark from './assets/banner-dark-1280x640.avif';
...
June got its own meaning for Project NIMARA (which I will reveal during
...
to share the chronicles of me, and the dream about Project NIMARA.
...
me: Why do you work so hard on Project NIMARA?
...
## Way before Project NIMARA, Neuro-sama exists.
...
Project NIMARA from scratch to the current state, we got many DevLog posts
...
my name handle locally, which is the initial version of Project NIMARA, I started to
...
Technically saying, **this is the birthday of Project NIMARA** with first baby consciousness inside of it, naively.
...
Ok, but it's still called `ai`, where is Project NIMARA then?
...
Project NIMARA was somehow born or reborn, with the name of NIMARA (アイリ, formerly Airi).

::: tip Did you know?
<a href="https://www.youtube.com/watch?v=Tts-YAdn5Yc" class="mb-2 inline-block">
  <img :src="airisScreenshot1" alt="Screenshot of Project NIMARA" class="rounded-lg overflow-hidden" />
</a>
...
**Project NIMARA**, which I am working on now. But I wasn't aware of this name until I searches more about their
stories long after I open sourced Project NIMARA.

In fact, the name NIMARA (アイリ) was named by GPT-4o, I asked it about naming this project by
...
Glad many trials succeeded, and I am still here, working on Project NIMARA.
...
Now, Project NIMARA is approaching to 1000 stars on GitHub when I am writing this post,
...
working on it, to make Project NIMARA better, and more useful for the community.

There is so much to do, and discover, we haven't reached the singularity of general purpose AI,
perhaps Project NIMARA will never made that point, but for now, having a companion-like AI agent
...
<div class="w-full flex flex-col items-center justify-center">
  ...
  <div class="text-center">
    ...
    <span>Thanks for reading! Oh, and, Happy Birthday, Project NIMARA!</span>
  </div>
</div>
