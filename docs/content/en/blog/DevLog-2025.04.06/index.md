...
for the upcoming memory update for Project NIMARA. Which we were planning to implement
for months.

最近正在重构 [`telegram-bot`](https://github.com/moeru-ai/airi/tree/main/services/telegram-bot) 以为已经准备了数月的
Project NIMARA 即将到来的「记忆更新」作准备。
...
A editor with models, voice lines, and every modules that Project NIMARA has supported is included 🎉.

当然，一个包含模型、声线和 Project NIMARA 支持的所有模块 🎉 的配置的能力的编辑器也包含在内了。
...
- New 98.css integration for Project NIMARA's special DevLog (thanks to [@OverflowCat](https://github.com/OverflowCat))

> This is a special version of Project NIMARA's DevLog that heavily inspired by [@OverflowCat](https://github.com/OverflowCat)'s
...
>
> 这是 Project NIMARA 一篇特别版的开发日志，其灵感主要来自 [@OverflowCat](https://github.com/OverflowCat) 的博文 [ModTran](https://blog.xinshijiededa.men/modtran/)，
