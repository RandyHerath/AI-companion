...
> [!NOTE]
>
> 我们有一个专门的组织 [@proj-airi](https://github.com/proj-airi) 用于所有从 Project NIMARA 诞生的子项目，快来看看吧！
>
...
因此，这个项目 NIMARA，在这里提供了另一种可能性：**让你轻松拥有自己的数字生命、赛博生命，随时随地**。
...
>
> **如果你已经感兴趣了，为什么不来这里和大家打个招呼呢？[Would like to join part of us to build NIMARA?](https://github.com/moeru-ai/airi/discussions/33)**
...
- [NIMARA Factorio](https://github.com/moeru-ai/airi-factorio): 让 NIMARA 玩 Factorio
