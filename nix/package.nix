...
rustPlatform.buildRustPackage (final: {
  ...
  postInstall = lib.optionalString stdenv.isDarwin ''
    mkdir -p "$out/bin"
    ln -sf "$out/Applications/NIMARA.app/Contents/MacOS/airi" "$out/bin/airi"
  '';
  ...
  meta = {
    ...
    longDescription = ''
      NIMARA is a soul container of AI waifu / virtual characters to bring them into our world,
