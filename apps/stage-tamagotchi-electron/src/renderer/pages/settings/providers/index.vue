  ...
  <div mb-6 flex flex-col gap-5>
    <div bg="primary-500/10 dark:primary-800/25" rounded-lg p-4>
      ...
      <div text="primary-700 dark:primary-300">
        NIMARA requires at least one <div bg="primary-500/10 dark:primary-800/25" inline-flex items-center gap-1 rounded-lg px-2 py-0.5 translate-y="[0.25lh]">
        ...
        it as the brain of the characters living in NIMARA system.
      </div>
    </div>
